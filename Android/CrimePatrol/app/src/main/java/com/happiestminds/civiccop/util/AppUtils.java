...
public class AppUtils {
    ...
    public static String loadJSONFromAsset(Context cxt) {
        String json = null;
        try {
            InputStream is = cxt.getAssets().open("crimetype.json");
    ...
    public static Category jsonToObject(String json) {
       // Jackson
       /* ObjectMapper mapper = new ObjectMapper();
        try {
            obj = mapper.readValue(json, Category.class);
        } catch (IOException e) {
            e.printStackTrace();
        }*/
