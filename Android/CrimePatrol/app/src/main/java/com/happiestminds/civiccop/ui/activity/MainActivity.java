...
import com.happiestminds.civiccop.model.events.UserCredsEvent;
import com.happiestminds.civiccop.model.response.ApiResponse;
import com.happiestminds.civiccop.service.webservices.ApiService;
import com.happiestminds.civiccop.ui.fragment.ItemListFragment;
...
//        RootRef.init(getResources().getString(R.string.firebase_url));
        mFirebaseRef = RootRef.getInstance();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ItemListFragment(), "Category_old 1");
        adapter.addFragment(new ItemListFragment(), "Category_old 2");
        adapter.addFragment(new ItemListFragment(), "Category_old 3");
